...
public class MapImpl extends WorldMap {
    private static final String coreAssetPath = "\\Zombie\\Common\\src\\main\\resources\\Assets\\";
    ...
    public void create() {
        ...
        map = loader.load(AssetLoader.getAssetPath(coreAssetPath,"Map/widemap.tmx"));
